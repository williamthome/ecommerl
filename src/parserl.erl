...
-export([quote/1, quote/2, unquote/1, unquote/2, insert_above/2, insert_below/2,
         ...
         function_exists/3, foldl/2, debug/1, revert/1, write_file/2,
...
function_exists(Name, Arity, [{function, _, Name, Arity, _} = Fun | _]) ->
    {true, Fun};
function_exists(Name, Arity, [_ | T]) ->
    function_exists(Name, Arity, T);
function_exists(_, _, []) ->
    false.
